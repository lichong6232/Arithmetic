...
public class Prim {
	...
	public List<Endge> prim(){
		int currentIndex=0;
		List<Endge> result=new ArrayList<Endge>();
	...
	public static void main(String[] args) {
		...
		List<Endge> result=prim.prim();
		for(Endge endge:result){
			System.out.print(prim.vertixList[endge.sourceIndex].label +"--------->");
			System.out.print(prim.vertixList[endge.destIndex].label);
			System.out.println();
		}
	}
